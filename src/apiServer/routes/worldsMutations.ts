...
// POST /api/worlds
router.post('/api/worlds', async (request, response) => {
...
router.delete('/api/worlds/:worldId', (request, response) => {
...
router.put('/api/worlds/:worldId/quality', (request, response) => {
  const { worldId } = request.params as { worldId: string };
...
router.put('/api/worlds/:worldId/tags', (request, response) => {
  const { worldId } = request.params as { worldId: string };
